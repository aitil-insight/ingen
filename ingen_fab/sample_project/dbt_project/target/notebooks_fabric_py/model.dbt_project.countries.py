...
# MAGIC   merge into lh_silver.countries as DBT_INTERNAL_DEST
# MAGIC       using countries__dbt_tmp as DBT_INTERNAL_SOURCE
# MAGIC       on 
# MAGIC               DBT_INTERNAL_SOURCE.CountryID = DBT_INTERNAL_DEST.CountryID
