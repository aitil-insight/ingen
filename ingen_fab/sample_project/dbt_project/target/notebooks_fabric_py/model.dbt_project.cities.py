...
sql = '''
    create or replace temporary view cities__dbt_tmp as
...
# MAGIC   merge into lh_silver.cities as DBT_INTERNAL_DEST
# MAGIC       using cities__dbt_tmp as DBT_INTERNAL_SOURCE
# MAGIC       on 
